    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n\n\n\nChoose one of the options below:\n" +
                   "///////////////////////////////////////\n" +
                   "Choose '1' To join us creating new customer account.\n" +
                   "Choose '2' If you an existing customer.\n" +
                   "Choose '3' To join us creating new vendor account.\n" +
                   "Choose '4' If you an existing vendor.\n" +
